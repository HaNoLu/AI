...
def get_predictor():
    # khoi tao predictor khi can thiet
    global predictor
...
def api_predict():
    ...
    try:
        ...
        session['history'].insert(0, history_entry)  # Mới nhất lên đầu
...
def api_import_predict():
    # api doc file excel/csv, du doan va tra ve file excel
    ...
    try:
        ...
        # Nếu không tìm thấy cột chuẩn, lấy cột đầu tiên có dữ liệu chuỗi hoặc cột đầu tiên
        ...
        # Tạo file excel kết quả trong bộ nhớ
        output = io.BytesIO()
